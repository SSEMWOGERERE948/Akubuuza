...
export const metadata = {
  title: 'Gallery - Akubuuza Farm Photos',
  description: 'Take a visual tour of our farm. See our free-range chickens, dedicated staff, egg collection process, and delivery operations.',
}
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="bg-gradient-to-r from-green-600 to-green-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 max-w-2xl mx-auto">
            Take a visual journey through Akubuuza Farm. See our free-range chickens, 
            dedicated team, and the care that goes into every egg.
          </p>
        </div>
      </section>
      ...
      {galleryCategories.map((category, categoryIndex) => (
        <section key={categoryIndex} className={`py-16 ${categoryIndex % 2 === 0 ? 'bg-white dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-800'}`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {category.images.map((image, imageIndex) => (
                <div key={imageIndex} className="group relative overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
            We welcome visitors to see our operations firsthand. Schedule a farm tour to experience 
            our sustainable practices and meet our happy chickens.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => window.open('https://wa.me/256700000000?text=Hi! I would like to schedule a farm tour. Please let me know available dates and times.', '_blank')}
